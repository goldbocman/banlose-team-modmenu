...
public class Preferences {
    ...
    public static native void Changes(Context context, int feature, int value, boolean bool, String str,String Strin);

    public static void changeFeatureInt(String feature, int featureNum, int value) {
        Changes(context, featureNum, value, false, feature,null);
    ...
    public static void changeFeatureString(String featureName, int featureNum, String str) {
        Changes(context, featureNum, 0, false, featureName, str);
        SharedPreferences sharedPreferences = getDefaultSharedPreferences(context);
        editor = sharedPreferences.edit();
    ...
    public static void changeFeatureBoolean(String feature, int featureNum, boolean value) {
        ...
        if (featureNum == -3)
            savePref = value;
        Changes(context, featureNum, 0, value, feature,null);
        SharedPreferences sharedPreferences = getDefaultSharedPreferences(context);
        editor = sharedPreferences.edit();
    ...
    public static int loadPrefInt(String featureName, int featureNum) {
        try{
            if (savePref) {
                ...
                Changes(context, featureNum, i, false, featureName,null);
                return i;
            }
        }
    ...
    public static boolean loadPrefBoolean(String featureName, int featureNum) {
        try{
            ...
            if (savePref || featureNum <= 0) {
                ...
                Changes(context, featureNum, 0, bool, featureName,null);
                return bool;
            }
        }
        catch (ClassCastException e){
